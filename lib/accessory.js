...
export class YotoPlayerAccessory {
  ...
  constructor ({ platform, accessory, deviceModel }) {
    ...
    this.lastDayColor = '0xffffff'
    this.lastNightColor = '0xffffff'
  }
  ...
  setupNightlightServices () {
    ...
    nightlightActiveService
      .setCharacteristic(Characteristic.Name, 'Nightlight Active')
    ...
    dayNightlightActiveService
      .setCharacteristic(Characteristic.Name, 'Day Nightlight Active')
      .getCharacteristic(Characteristic.ContactSensorState)
    ...
    nightNightlightActiveService
      .setCharacteristic(Characteristic.Name, 'Night Nightlight Active')
      .getCharacteristic(Characteristic.ContactSensorState)
  ...
  setupCardSlotService () {
    ...
    service
      .setCharacteristic(Characteristic.Name, 'Card Slot')
      .getCharacteristic(Characteristic.ContactSensorState)
  ...
  setupNightModeService () {
    ...
    service
      .setCharacteristic(Characteristic.Name, 'Night Mode')
  ...
  setupSleepTimerService () {
    ...
    service
      .setCharacteristic(Characteristic.Name, 'Sleep Timer')
  ...
  setupBluetoothService () {
    ...
    service
      .setCharacteristic(Characteristic.Name, 'Bluetooth')
      .getCharacteristic(Characteristic.On)
  ...
  setupVolumeLimitServices () {
    ...
    dayService
      .setCharacteristic(Characteristic.Name, 'Day Max Volume')
    ...
    nightService
      .setCharacteristic(Characteristic.Name, 'Night Max Volume')
      .getCharacteristic(Characteristic.Active)
      .onGet(() => Characteristic.Active.ACTIVE)
  ...
  /**
   * Destroy accessory - cleanup event listeners
   * @returns {Promise<void>}
   */
  async destroy () {
